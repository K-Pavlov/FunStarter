...
#    url(r'^', include(route_config.get_router().urls)),
    ...
    url(r'^api/stories/(?P<id>[-\w]+)/$', 'rest_service.views.story'),
    url(r'^api/pictures/(?P<id>[-\w]+)/$', 'rest_service.views.picture'),
    url(r'^api/comments/(?P<data_type>[-\w]+)/(?P<id>[-\w]+)', 'rest_service.views.add_comment'),
